...
lbl = tk.Label(root, text="Criminal Identification using Machine Learning", font=('times', 40,' bold '), height=1, width=50,bg="gold",fg="white")
lbl.place(x=0, y=5)
...
button1 = tk.Button(framed, text='Criminal Identification',width=20,height=3,bg='dark blue',fg='white',command=criminal,font='bold').place(x=150,y=50)
